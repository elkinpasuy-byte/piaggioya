      ...
      {showMenu && (
        <>
          ...
          <div style={styles.menu}>
            ...
            <button onClick={() => { setShowMenu(false); navigate('/client/request'); }} style={styles.menuItem}>
              📦 Solicitar envío
            </button>
            <button onClick={() => { setShowMenu(false); navigate('/client/trips'); }} style={styles.menuItem}>
              📋 Mi historial
            </button>
